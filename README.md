...
- Quote submission form capturing insured/risk name, broker or source, risk class (16 classes: All Risks, Art Works All Risk, Boiler, Burglary, Business Interruption, CAR, Combined Policy, Delay In Start Up, EAR, Electronic Equipment, Fire and Special Perils, Fire only, Householder, IAR, Plant All Risk, Others), month, year, sum insured, premium, conversion status, and the Relationship Officer's comment.
